...
ActiveRecord::Schema.define(version: 2021_01_14_053534) do
  ...
  create_table "recipe_tags_recipes", id: false, force: :cascade do |t|
    ...
    t.index ["recipe_id"], name: "index_recipe_tags_recipes_on_recipe_id"
    t.index ["recipe_tag_id"], name: "index_recipe_tags_recipes_on_recipe_tag_id"
  end
